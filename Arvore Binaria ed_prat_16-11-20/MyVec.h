...
//Excecao usada pela classe MyVec
...
private:
	...
	void create(); //cria um vetor completamente vazio...
	void destroy();
	void resizeCapacity(int newCapacity); //modifica a capacidade do vetor (nao faz nada se nova capacidade for menor!).. Talvez deixar publico?
};
